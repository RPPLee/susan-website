...
test('the presence record and proposals round-trip byte-identical', { skip: !existsSync(join(here, '..', 'presence.md')) }, () => {
  for (const f of [join(here, '..', 'presence.md'), join(here, '..', '..', '..', '..', '.scratch', 'presence', 'decisions.md')]) {

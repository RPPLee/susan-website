...
The README's Drawn pictures section has the rules (page tokens only, no raster, about 320 px
wide on the page). A card that names a screen is not drawn. Run `undrawn` again: it must print
